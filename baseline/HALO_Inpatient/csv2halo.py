...
if __name__ == "__main__":
    ...
    args_parser.add_argument("--save_path","-S",type=str,default="results/datasets/")
    ...
    synth_path = args.test_path
    print("Loading Data...")
    dummy_df = pd.read_csv(synth_path)
    ...
    save_path = os.path.join(args.save_path,f"{model}{args.serial}Dataset.pkl")
    print(f"Saving Data at {save_path}...")
    pickle.dump(dummy_data,open(save_path, "wb"))
