...
os.system(f"python evaluate_privacy_attribute.py -L {data_path} -M {args.model}")
os.system(f"python evaluate_privacy_membership.py -L {data_path} -M {args.model}")
os.system(f"python evaluate_privacy_nearest.py -L {data_path} -M {args.model}")
