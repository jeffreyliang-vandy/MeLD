...
args_parser.add_argument("--seed", "-S", type=int, default=0)
...
# index_to_code = pickle.load(open("./data/datasets/hiv/indexToCode.pkl", "rb"))
# id_to_label = pickle.load(open("./data/datasets/hiv/idToLabel.pkl", "rb"))
...
checkpoint = torch.load(f'./save/halo_model{args.serial}', map_location=torch.device(device))
...
pickle.dump(synthetic_ehr_dataset, open(f'./results/datasets/haloDataset{SEED}.pkl', 'wb'))